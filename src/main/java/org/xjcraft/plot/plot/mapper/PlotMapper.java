...
public interface PlotMapper extends CommonMapper {
    String INSERT_FIELDS = "id, world_name, x1, z1, x2, z2, addtime, sell_type, sell_price";
    String SELECT_FIELDS = "id, world_name AS worldName, x1, z1, x2, z2, addtime, sell_type AS sellType, sell_price AS sellPrice";
    ...
    @Insert({
            "INSERT INTO ",
              TABLE_NAME, "(",
                INSERT_FIELDS,
              ") VALUES (#{plot.id}, #{plot.worldName}, #{plot.x1}, #{plot.z1}, #{plot.x2}, #{plot.z2}, #{plot.addtime}, #{plot.sellType}, #{plot.sellPrice})"
    })
