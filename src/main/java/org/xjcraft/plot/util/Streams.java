...
public class Streams {
     ...
     * @throws IOException 如果拷贝过程中出现 IO 异常
     */
    public static long copy(@NonNull InputStream in, @NonNull OutputStream out, int bufSize) throws IOException {
     ...
     * @throws IOException 如果拷贝过程中出现 IO 异常
     */
    public static long copy(@NonNull InputStream in, @NonNull OutputStream out, boolean closeOutputStream, byte[] buf) throws IOException {
        try {
            // 总共拷贝的字节数
            var total = 0;
            // 循环拷贝
     ...
     * @throws IOException 如果拷贝过程中出现 IO 异常
     */
    public static byte[] readAllAsBytes(@NonNull InputStream in) throws IOException {
